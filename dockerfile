ode
 ...
 {
 mail bcc: 'patrickhimwiitamyers', body: '''Build is over
 Thanks,
 Landmark Technologies,
 2108871852.''', cc: 'patrickhimwiitamyers@gmail.com', from: '', replyTo: '', subject: 'Build is over!!', to: 'patrickhimwiitamyers@gmail.com'
 }
 */
